...
type Role struct {
	...
	Privs        structs.JSONMap `gorm:"column:privs;type:json;size:65535;default:{'cRate':0,'cFeature':0,'cEpic':0,'cVerCoins':0,'cDaily':0,'cWeekly':0,'cDelete':0,'cLvlAccess':0,'aRateDemon':0,'aRateStars':0,'aReqMod':0,'dashboardMod':0,'dashboardBan':0,'dashboardCreatePack':0};" json:"privs"`
}
