...
type Transaction struct {
	...
	PayID     string    `gorm:"column:pay_id;type:varchar(32);size:32;default:0;" json:"pay_id"`
	...
	Method    string    `gorm:"column:method;type:varchar(32);size:32;default:xx;" json:"method"`
	GoPayURL  string    `gorm:"column:goPayUrl;type:varchar(1024);size:1024;" json:"go_pay_url"`
}
