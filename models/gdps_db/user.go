...
type User struct {
	...
	Uname              string        `gorm:"column:uname;type:varchar(16);size:16;" json:"uname"`
	Passhash           string        `gorm:"column:passhash;type:varchar(128);size:128;" json:"-"`
	Email              string        `gorm:"column:email;type:varchar(256);size:256;" json:"email"`
	...
	LastIP             string        `gorm:"column:lastIP;type:varchar(64);size:64;default:Unknown;" json:"last_ip"`
	...
	ProtectMeta        types.JSONMap `gorm:"column:protect_meta;type:json;size:4294967295;default:{'comm_time':0,'post_time':0,'msg_time':0};" json:"protect_meta"`
	...
	Chests             types.JSONMap `gorm:"column:chests;type:json;size:4294967295;default:{'small_count':0,'big_count':0,'small_time':0,'big_time':0};" json:"-"`
	Settings           types.JSONMap `gorm:"column:settings;type:json;size:4294967295;default:{'frS':0,'cS':0,'mS':0,'youtube':'','twitch':'','twitter':''};" json:"settings"`
	Moons              int           `gorm:"column:moons;type:int;default:0;" json:"moons"`
	Gjphash            string        `gorm:"column:gjphash;type:varchar(64);size:64;" json:"-"`
}
