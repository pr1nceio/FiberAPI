...
type ShopItem struct {
	...
	Image       string `gorm:"column:image;type:varchar(512);size:512;" json:"image"`
	Description string `gorm:"column:description;type:varchar(512);size:512;" json:"description"`
	Currency    string `gorm:"column:currency;type:varchar(3);size:3;default:USD;" json:"currency"`
