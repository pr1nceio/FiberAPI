...
import (
	"database/sql"
	"github.com/fruitspace/HyprrSpace/models/types"
	"time"
)
...
type ServerGD struct {
	...
	SrvName           string         `gorm:"column:srvName;type:varchar(32);size:32;" json:"srv_name"`
	Plan              int            `gorm:"column:plan;type:tinyint;" json:"plan"`
	OwnerID           int            `gorm:"column:owner_id;type:int;" json:"owner_id"`
	DbPassword        string         `gorm:"column:dbPassword;type:varchar(64);size:64;" json:"db_password"`
	SrvKey            string         `gorm:"column:srvKey;type:varchar(32);size:32;" json:"srv_key"`
	...
	ClientAndroidURL  string         `gorm:"column:clientAndroidURL;type:varchar(255);size:255;" json:"client_android_url"`
	ClientIOSURL      string         `gorm:"column:clientIOSURL;type:varchar(255);size:255;" json:"client_ios_url"`
	ClientWindowsURL  string         `gorm:"column:clientWindowsURL;type:varchar(255);size:255;" json:"client_windows_url"`
	ClientMacOSURL    string         `gorm:"column:clientMacOSURL;type:varchar(255);size:255;" json:"client_macos_url"`
	...
	MStatHistory      types.JSONMap  `gorm:"column:mStatHistory;type:json;" json:"m_stat_history"`
	Icon              string         `gorm:"column:icon;type:varchar(16);size:16;default:gd_default.png;" json:"icon"`
	Description       string         `gorm:"column:description;type:varchar(1000);size:1000;default:Welcome to my GDPS!;" json:"description"`
	...
	Discord           string         `gorm:"column:discord;type:varchar(128);size:128;" json:"discord"`
	Vk                string         `gorm:"column:vk;type:varchar(128);size:128;" json:"vk"`
	...
	Version           string         `gorm:"column:version;type:varchar(8);size:8;default:2.2;" json:"version"`
	Recipe            string         `gorm:"column:recipe;type:longtext;" json:"recipe"`
	DownloadPageStyle types.JSONMap  `gorm:"column:downloadPageStyle;type:json;" json:"downloadpage_style"`
}
